...
The preprocessing steps go as follows:
  ...
  2. Calculate Total Process Time (Start) ->
      Cumulative sum of the durations of the activities, relative to the start_time of each activity.
      (Note: The last number of each process is the cumsum untill the starttime of the last activity.)
